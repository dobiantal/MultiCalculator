def calc_view():
    ...
    from App.operators import Addition
    from App.operators import negyzetgyok
    from App.operators import multiplicate
    from App.operators import div
    from App.operators import subtract
    ...
    From_top: int = 200
    calc_window.geometry(f'{Width}x{Height}+{From_top_left}+{From_top}')

    """*A kijelző mező"""
    Display = tk.Entry(calc_window,font=("Times New Roman",25))
    Display.focus_force()
    ...
    *Az alábbi kód implementálja a fő ablakon a funkció gombokat és a kattintási methodusokat.
    ...
    Zero = tk.Button(calc_window,text=0, bg='#065ef9', font=("Times New Roman",25),command=lambda:ZeroC())
    Zero.place(relwidth=0.15, relheight=0.15, relx=0.25, rely=0.75)
    def OneC():
        Display.insert("end","1")
    One = tk.Button(calc_window,text=1, bg='#065ef9', font=("Times New Roman",25),command=lambda:OneC())
    One.place(relwidth=0.15, relheight=0.15, relx=0.1, rely=0.6)
    def TwoC():
        Display.insert("end","2")
    Two = tk.Button(calc_window,text=2, bg='#065ef9', font=("Times New Roman",25),command=lambda:TwoC())
    Two.place(relwidth=0.15, relheight=0.15, relx=0.25, rely=0.6)
    def ThreeC():
        Display.insert("end","3")
    Three = tk.Button(calc_window,text=3, bg='#065ef9', font=("Times New Roman",25),command=lambda:ThreeC())
    Three.place(relwidth=0.15, relheight=0.15, relx=0.4, rely=0.6)
    def FourC():
        Display.insert("end","4")
    Four = tk.Button(calc_window,text=4, bg='#065ef9', font=("Times New Roman",25),command=lambda:FourC())
    Four.place(relwidth=0.15, relheight=0.15, relx=0.1, rely=0.45)
    def FiveC():
        Display.insert("end","5")
    Five = tk.Button(calc_window,text=5, bg='#065ef9', font=("Times New Roman",25),command=lambda:FiveC())
    Five.place(relwidth=0.15, relheight=0.15, relx=0.25, rely=0.45)
    def SixC():
        Display.insert("end","6")
    Six = tk.Button(calc_window,text=6, bg='#065ef9', font=("Times New Roman",25),command=lambda:SixC())
    Six.place(relwidth=0.15, relheight=0.15, relx=0.4, rely=0.45)
    def SevenC():
        Display.insert("end","7")
    Seven = tk.Button(calc_window,text=7, bg='#065ef9', font=("Times New Roman",25),command=lambda:SevenC())
    Seven.place(relwidth=0.15, relheight=0.15, relx=0.1, rely=0.30)
    def EightC():
        Display.insert("end","8")
    Eight = tk.Button(calc_window,text=8, bg='#065ef9', font=("Times New Roman",25),command=lambda:EightC())
    Eight.place(relwidth=0.15, relheight=0.15, relx=0.25, rely=0.30)
    def NineC():
        Display.insert("end","9")
    Nine = tk.Button(calc_window,text=9, bg='#065ef9', font=("Times New Roman",25),command=lambda:NineC())
    ...
    *Minden funkciógomb első leütésre eltárolja az OPERANDUS_A változóba az első számértéket a mi a művelethez kell.
    ...
    Sum = tk.Button(calc_window,text="+", bg='#065ef9', font=("Times New Roman",25),command=lambda: SumOp())
    ...
    def SubOp():
        ...
        OPERANDUS_A = Display.get()
        Display.delete(0,'end')
    Sub = tk.Button(calc_window,text="-", bg='#065ef9', font=("Times New Roman",25),command=lambda: SubOp())
    ...
    def MultiOp():
        ...
        OPERANDUS_A = Display.get()
        Display.delete(0,'end')
    Multip = tk.Button(calc_window,text="*", bg='#065ef9', font=("Times New Roman",25),command=lambda: MultiOp())
    ...
    def DivOp():
        ...
        OPERANDUS_A = Display.get()
        Display.delete(0,'end')
    Div = tk.Button(calc_window,text="/", bg='#065ef9', font=("Times New Roman",25),command=lambda: DivOp())
    ...
    def EvomOp():
        ...
        OPERANDUS_A = 0
        OPERATOR = ""
    Evo = tk.Button(calc_window,text="√", bg='#065ef9', font=("Times New Roman",25),command=lambda: EvomOp())
    ...
    def EqOp_BR(event):
        EqOp()
    Eq = tk.Button(calc_window,text="=", bg='#065ef9', font=("Times New Roman",25),command=lambda: EqOp())
    ...
    *Törlő methodus letörli a képernyőt a CE gomb lenyomására. 
    ...
    def Clear_display():
        Display.delete(0,'end')
    CE = tk.Button(calc_window,text="CE", bg='#065ef9', font=("Times New Roman",25),command=lambda: Clear_display())
